...
namespace spi {
auto SPI::Transfer(std::vector<uint8_t> &mosi_data_buffer,
                   std::vector<uint8_t> &miso_data_buffer) noexcept -> types::DriverStatus {
...
auto SPI::Write(std::vector<uint8_t> &mosi_data_buffer) const noexcept -> types::DriverStatus {
...
auto SPI::IsMisoBufferTooSmall(std::vector<uint8_t> &mosi_buffer, std::vector<uint8_t> &miso_buffer) const noexcept -> bool {
