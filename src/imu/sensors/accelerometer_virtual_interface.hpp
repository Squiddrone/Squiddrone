...
class AccelerometerInterface : public InertialMeasurementSensorWithSensitivity {
 public:
  AccelerometerInterface() = delete;
  ~AccelerometerInterface() = default;

  explicit AccelerometerInterface(std::shared_ptr<i2c::I2CInterface> i2c_handler) : InertialMeasurementSensorWithSensitivity(i2c_handler){};
