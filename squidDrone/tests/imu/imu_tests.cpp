...
namespace{
  ...
  TEST(imu, imu_interface_get_gyroscope){
    i2c::I2CHandler i2c_handler;
    imu::InertialMeasurementInterface imu_interface(i2c_handler);
  ...
  TEST(imu, imu_interface_get_accelerometer){
    i2c::I2CHandler i2c_handler;
    imu::InertialMeasurementInterface imu_interface(i2c_handler);
  ...
  TEST(imu, imu_interface_get_magnetometer){
    i2c::I2CHandler i2c_handler;
    imu::InertialMeasurementInterface imu_interface(i2c_handler);
  ...
  TEST(imu, imu_interface_get_temperature){
    i2c::I2CHandler i2c_handler;
    imu::InertialMeasurementInterface imu_interface(i2c_handler);
