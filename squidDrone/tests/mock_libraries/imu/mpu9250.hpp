...
class Mpu9250 final : public GenericInertialMeasurementUnit{
  ...
  protected:
    types::GyroscopeSensitivity gyroscope_sensitivity =
        types::GyroscopeSensitivity::FINEST;
    types::AccelerometerSensitivity accelerometer_sensitivity =
        types::AccelerometerSensitivity::FINEST;
